...
class UserManager
{
	 ...
	 * @return array array of result with all var for template
	 */
	function changePassword($keyToken)
	{
	 ...
	 * @return array array of result with all var for template
	 */
	function changePasswordForm($keyToken)
	{
		$token = (App::getDB())->prepare((new AuthQuery())->getTokenQuery($keyToken),"select","app\model\Token",true);
		if ($token != false)
		{
			return [
				'result' => true,
	 ...
	 * @return array array of result with all var for template
	 */
	function validEmail($keyToken)
	{
		$token = (App::getDB())->prepare((new AuthQuery())->getTokenQuery($keyToken),"select","token",true);
